...
public class PostClientDataRequest extends AbstractRestRequest {
	...
	*/
	...
	public String toString() {
		return "PostClientDataRequest [platform=" + platform + ", channel=" + channel + ", ismobiledevice="
				+ ismobiledevice + ", havewifi=" + havewifi + ", imei=" + imei + ", userid=" + userid + ", appkey="
				+ appkey + ", resolution=" + resolution + ", network=" + network + ", version=" + version
				+ ", os_version=" + os_version + ", deviceid=" + deviceid + ", havebt=" + havebt + ", phonetype="
				+ phonetype + ", havegps=" + havegps + ", modulename=" + modulename + ", time=" + time + ", wifimac="
				+ wifimac + ", devicename=" + devicename + ", mccmnc=" + mccmnc + ", imsi=" + imsi + ", language="
				+ language + ", havegravity=" + havegravity + ", salt=" + salt + ", longitude=" + longitude
				+ ", latitude=" + latitude + "]";
	}
